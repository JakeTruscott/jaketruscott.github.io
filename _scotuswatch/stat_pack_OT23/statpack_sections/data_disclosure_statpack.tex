...
\noindent All data used to compile this report are available \textcolor{blue}{\href{https://empiricalscotus.com/2023-stats/}{HERE}}. Here you will find a collection of CSV (.csv) files containing data relevant to the accompanying analyses on \emph{Decisions} and \emph{Oral Arguments} provided in this report. For guidance on data usage and replication, please see the document entitled \emph{Data and Replication Guide}.  \\
