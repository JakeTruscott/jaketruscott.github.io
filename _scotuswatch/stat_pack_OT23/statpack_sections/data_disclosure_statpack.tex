...
\noindent All data used to compile this report are available \textcolor{blue}{\href{https://empiricalscotus.com/2023-stats/}{HERE}}. For guidance on data usage and replication, please see the document entitled \emph{Data and Replication Guide}. Among these are a folder entitled \emph{Data Files}, which offers a collection of CSV (.csv) files containing data relevant to the accompanying analyses on \emph{Decisions} and \emph{Oral Arguments} provided in this report. \\
...
\noindent These files and accompanying data are free and available for public use. We just ask that any publication incorporating these data or other material from our report provide a corresponding citation acknowledging the authors, EmpiricalSCOTUS, and any relevant data sourcs indicated with the enclosed tabular information. \\
