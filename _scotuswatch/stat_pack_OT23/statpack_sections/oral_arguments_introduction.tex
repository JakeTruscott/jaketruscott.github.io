\begin{center}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.75\textwidth]{Figures/hennessey_courtroom_sketch.jpg} \\
        \footnotesize{Photo Credit: Courtroom sketch by Bill Hennessy (PBS NewsHour)} \\
		\includegraphics[width=0.75\textwidth]{Figures/hennessey_courtroom_sketch_2.jpg} \\
