...
\begin{figure}[H]
\centering
\caption{Average Number of Amici Filed by Granted and Denied Petitions (OT18-OT23)}
\vspace{1.5mm}
\includegraphics[width = 0.7\textwidth]{"Figures/statpack_figures/average_amici_filed_by_granted_type_term.png"}
\end{figure}

\raggedright{
\footnotesize{\emph{Note:} The x-axis (\emph{Filing Year}) represents the term when the petition was filed -- \textbf{not} when it was granted or denied review. For example, \emph{Acheson Hotels, LLC v. Laufer} (No. 22-429) was filed during the 2022 term but was argued this term (OT2023). As such, it would be included in the bar referencing the 2022 filing year. \\
\vspace{2.5mm}
...
\begin{figure}[H]
\centering
\caption{Average Number of Amici Filed in Cert and Merits Stages (OT23)}
\vspace{1.5mm}
