...
\vspace{1.5mm}
\includegraphics[width = 0.9\textwidth]{Figures/statpack_figures/decision_turnover_OT23.png}
\end{figure}
...
\vspace{1.5mm}
\includegraphics[width = 0.9\textwidth]{Figures/statpack_figures/decision_turnover_OT18_OT23.png} \\
\vspace{1.5mm}
