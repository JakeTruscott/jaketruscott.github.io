...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}p{0.33\textwidth}>{\centering\arraybackslash}X}
        ...
        \addlinespace
        Amicus Curiae Briefs & \RaggedRight Average volume of amicus briefs filed in Granted and Denied petitions (2018 to 2023 Terms), as well as summary statistics of ``Cert'' (pre-grant) and ``Merits'' (post-grant) stage amicus filings for cases argued in the 2023 term. \\
        \bottomrule
    \end{tabularx}
\end{table}
\end{center}
