...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}p{0.33\textwidth}>{\centering\arraybackslash}X}
        ...
        \addlinespace
        Decision Overviews & \RaggedRight OT2023 Decisions organized by sitting (month) with corresponding summary of case-level issue, docket number, holding, opinion author, and coalition size. \\
        \addlinespace
        Decisions by Coalition & \RaggedRight Summary of decisions by coalition size (i.e., 9-0, 8-1, etc.). \\
        \addlinespace
        Written Opinions & \RaggedRight Summary of written opinions (Majority, Concurrence, or Dissent) by Justice with corresponding author, page length, and word counts. \\
        \addlinespace
        Turnover Between Arguments and Decision & \RaggedRight Elapsed time (days) between Oral Argument \& Decision.  \\
        \addlinespace
